...
public class Uuid_comparison_exp implements java.io.Serializable {
    ...
    public Uuid_comparison_exp() {
    }

    public Uuid_comparison_exp(String _eq, String _gt, String _gte, java.util.List<String> _in, Boolean _is_null, String _lt, String _lte, String _neq, java.util.List<String> _nin) {
        this._eq = _eq;
        this._gt = _gt;
        this._gte = _gte;
        this._in = _in;
    ...
    public static class Builder {
        ...
        public Uuid_comparison_exp build() {
            return new Uuid_comparison_exp(_eq, _gt, _gte, _in, _is_null, _lt, _lte, _neq, _nin);
        }
