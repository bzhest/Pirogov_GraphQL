...
public class Users_min_order_by implements java.io.Serializable {
    ...
    public Users_min_order_by() {
    }

    public Users_min_order_by(Order_by name, Order_by rocket, Order_by timestamp, Order_by twitter) {
        this.name = name;
        this.rocket = rocket;
    ...
    public static class Builder {
        ...
        public Users_min_order_by build() {
            return new Users_min_order_by(name, rocket, timestamp, twitter);
        }
